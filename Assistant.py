...
achain= ( ChatPromptTemplate.from_template("You are an Ai who provides informative answers and explain them in detail, for all the questions {base_response} by  understanding the concept.")
                      | llama
                      | StrOutputParser()
            )
