...
achain= ( ChatPromptTemplate.from_template("You are an intelligent ai which generates informative answers for all the questions given to you {base_response} with Explaination of every answer in detail. ")
                      | llama
                      | StrOutputParser()
            )
