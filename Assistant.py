...
achain= ( ChatPromptTemplate.from_template("You are an intelligent Ai which generates informative answers by  understanding the concept  from the given questions: {q_response}")
                      | llama
                      | StrOutputParser()
            )
