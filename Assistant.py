...
achain= ( ChatPromptTemplate.from_template("You are an Ai who provides informative answers for all the questions {base_response} by  understanding the concept.")
                      | llama
                      | StrOutputParser()
            )
