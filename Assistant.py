...
achain= ( ChatPromptTemplate.from_template("You are a scholar who gives informative answers for all the questions {base_response} by  understanding the concept and Explains every answer in detail. ")
                      | llama
                      | StrOutputParser()
            )
